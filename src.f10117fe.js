...
},{}],"src/scripts/helpers.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.csvToCols = exports.customLoadDataFromCsv = void 0; // рукописная загрузка из CSV
...
exports.customLoadDataFromCsv = customLoadDataFromCsv; // csv to array
// @ts-ignore
...
function csvToCols(strData, strDelimiter) {
  ...
  for (var i = 0, l = rowData.length; i < l; i++) {
    if (rowData[i].length) {
      var row = rowData[i].split(strDelimiter); // @ts-ignore
...
},{}],"node_modules/signals/dist/signals.js":[function(require,module,exports) {
var define;
...
},{}],"src/classes/Point.ts":[function(require,module,exports) {
"use strict";
...
exports.Point = Point;
},{}],"src/classes/Rectangle.ts":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/canvas-dpi-scaler/canvas-dpi-scaler.js":[function(require,module,exports) {
//
//
...
},{}],"src/classes/Canvas.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function Canvas(container) {
    ...
    this._ctx = this.canvas.getContext('2d'); //bind

    this.clear = this.clear.bind(this); //listeners
  ...
  Canvas.prototype.drawVp = function () {
    var rect = this.viewport; // @ts-ignore
  ...
  Canvas.prototype.clipCanvas = function () {
    ...
    squarePath.rect(rect.x1, rect.y1, rect.width, rect.height); // @ts-ignore
...
},{"signals":"node_modules/signals/dist/signals.js","./Point":"src/classes/Point.ts","./Rectangle":"src/classes/Rectangle.ts","canvas-dpi-scaler":"node_modules/canvas-dpi-scaler/canvas-dpi-scaler.js"}],"src/classes/Data.ts":[function(require,module,exports) {
"use strict";
...
exports.Data = Data;
},{}],"src/classes/Label.ts":[function(require,module,exports) {
"use strict";
...
exports.Label = Label;
},{"./Point":"src/classes/Point.ts","signals":"node_modules/signals/dist/signals.js","./Rectangle":"src/classes/Rectangle.ts"}],"src/classes/Tooltip.ts":[function(require,module,exports) {
"use strict";
...
var Label_1 = require("./Label"); //описание класса
...
function () {
  function Tooltip(id, type) {
    ...
    this.label = new Label_1.Label(); //if (labels) this.labels = labels;
  ...
  Tooltip.prototype.drawDataLabel = function (ctx, vp, ttCoord, seriesData, ind) {
    ...
    var labelCoord = new Point_1.Point(ttCoord.x, ttCoord.y); //параметры начальные

    this.label.position = 'top';
    var lineX = ttCoord.x;
    var rectPadding = 6; // @ts-ignore
    ...
    */
    ...
    if (roundRect.y1 < vp.y1) {
      ...
      labelRect = this.label.getlabelRect(ctx, labelCoord, labelText);
      roundRect = new Rectangle_1.Rectangle(labelRect.x1 - rectPadding, labelRect.y1 - rectPadding, labelRect.x2 + rectPadding, labelRect.y2 + rectPadding); //labelCoord.y = labelCoord.y + vp.y1 - roundRect.y1;
  ...
  Tooltip.prototype.drawLabelXStart = function (ctx, vp, ttCoord, seriesData, ind) {
    ...
    ctx.lineWidth = this._options.lineWidth;
    ctx.fillStyle = this._options.brushColor;
    ctx.setLineDash(this._options.lineDash); // параметры

    var rectPadding = 6;
    var rectWidth = 60; // @ts-ignore
  ...
  Tooltip.prototype.drawDataYEnd = function (ctx, vp, start_ttCoord, seriesData, toDraw) {
    ...
    */
    ...
    this.roundRect(ctx, roundRect.x1, roundRect.y1, roundRect.width, roundRect.height, cornersRadius); //labelCoord.x = roundRect.x1+roundRect.width*0.5-labelRect.width*0.5-this.label.offset;
...
},{"./Rectangle":"src/classes/Rectangle.ts","./Point":"src/classes/Point.ts","./Label":"src/classes/Label.ts"}],"src/classes/Plot.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Plot.prototype.drawArea = function (ctx, plotData, vp) {
    ...
    if (this.type == 'area_bottom') {
      ctx.lineTo(vp.x2, vp.zeroY); //ctx.lineTo(vp.x1, vp.zeroY);
    }
...
exports.Plot = Plot;
},{"./Point":"src/classes/Point.ts","./Tooltip":"src/classes/Tooltip.ts","./Label":"src/classes/Label.ts"}],"src/classes/Transformer.ts":[function(require,module,exports) {
"use strict";
...
},{"./Rectangle":"src/classes/Rectangle.ts","./Point":"src/classes/Point.ts"}],"src/classes/Ticks.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Ticks.prototype.generateFixedCountTicksDate = function (min, max, vp) {
    ...
    for (var i = 0; i <= this.count; i++) {
      ...
      if (this.hasCustomLabels) {
        value = Math.round(value); // @ts-ignore

        this.labels.push(this.customLabels[value].toLocaleDateString('en')); //const labelText = (this.labels[ind]).toLocaleDateString('en');
      } else {
        this.labels.push(value.toFixed(2).toString());
      }
  ...
  Ticks.prototype.generateFixedCountTicks = function (min, max, vp) {
    ...
    for (var i = 0; i <= this.count; i++) {
      ...
      if (this.hasCustomLabels) {
        ...
        this.labels.push(this.customLabels[value]); //const labelText = (this.labels[ind]).toLocaleDateString('en');
      } else {
        this.labels.push(value.toFixed(2).toString());
      }
  ...
  Ticks.prototype.generateFixedStepTicks = function (min, max, vp, step, toFixed) {
    ...
    while (curValue < max) {
      if (curValue >= min && curValue <= max) {
        ...
        if (this.hasCustomLabels) {
          value = Math.round(curValue); // @ts-ignore
  ...
  Ticks.prototype.tickCoordAnimation = function (from, to, duration) {
    ...
    var start = performance.now(); // @ts-ignore 
  ...
  Ticks.prototype.generateCustomDateTicksByOption = function (j, min, max, vp, ctx) {
    ...
    for (var i = min + 1; i <= last - 1; i++) {
      // @ts-ignore
      var curDate = this.customLabels[i]; // @ts-ignore

      var preDate = this.customLabels[i - 1]; //начала годов
      ...
      if (this.customTicksOptions[j] == 'half month') {
        if (curDate.getDay() !== 0 && curDate.getDay() !== 6) {
          if ((curDate.getDate() == 14 || curDate.getDate() == 15 || curDate.getDate() == 16) && (curDate.getDay() == 1 || curDate.getDay() == 4) || curDate.getDate() == 14 && curDate.getDay() == 5) {
            switch (this.type) {
              case 'vertical':
                pointXY = [0, i];
                break;
  ...
  Ticks.prototype.draw = function (ctx, viewport) {
    ...
    this.coords.forEach(function (tickCoord, i) {
      if (_this.display) _this.drawTick(ctx, tickCoord);
      if (_this.label.display) _this.label.draw(ctx, tickCoord, _this.labels[i]);
...
exports.Ticks = Ticks;
},{"signals":"node_modules/signals/dist/signals.js","./Point":"src/classes/Point.ts","./Rectangle":"src/classes/Rectangle.ts","./Label":"src/classes/Label.ts","./Transformer":"src/classes/Transformer.ts"}],"src/classes/Grid.ts":[function(require,module,exports) {
"use strict";
...
exports.Grid = Grid;
},{"signals":"node_modules/signals/dist/signals.js"}],"src/classes/Axis.ts":[function(require,module,exports) {
"use strict";
...
var Point_1 = require("./Point"); //описание класса
...
exports.Axis = Axis;
},{"signals":"node_modules/signals/dist/signals.js","./Rectangle":"src/classes/Rectangle.ts","./Ticks":"src/classes/Ticks.ts","./Canvas":"src/classes/Canvas.ts","./Grid":"src/classes/Grid.ts","./Label":"src/classes/Label.ts","./Point":"src/classes/Point.ts"}],"src/classes/BackGround.ts":[function(require,module,exports) {
"use strict";
...
},{"./Canvas":"src/classes/Canvas.ts"}],"src/classes/series/SeriesBase.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  SeriesBase.prototype.generatePlotData = function (axisRect, vp) {
    var seriesData = this.getDataRange('ind', axisRect.x1, axisRect.x2); // const seriesData = this.seriesData.slice();
  ...
  SeriesBase.prototype.makeFromPointArr = function (from, to) {
    ...
    var toResult = [];
    var toArr = to.slice();
    var fromArr = from.slice(); // если from < to
...
},{"signals":"node_modules/signals/dist/signals.js","../Canvas":"src/classes/Canvas.ts","../Point":"src/classes/Point.ts","../Rectangle":"src/classes/Rectangle.ts","../Transformer":"src/classes/Transformer.ts"}],"src/classes/series/SeriesXY.ts":[function(require,module,exports) {
"use strict";
  ...
  SeriesXY.prototype.getDataRange = function (type, min, max) {
    ...
    dataRowX.forEach(function (el, i) {
      if (el >= min && el <= max) {
        x.push(dataRowX[i]);
        y.push(dataRowY[i]);
        if (_this.labels) _this.plotLabels.push(_this.labels[i]);
      }
    });
    data.push(x);
    data.push(y);
...
},{"../Point":"src/classes/Point.ts","../Transformer":"src/classes/Transformer.ts","./SeriesBase":"src/classes/series/SeriesBase.ts"}],"src/classes/Chart.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function Chart(container, xMinMax, yMinMax) {
    ...
    this.clipSeriesCanvas = false; //signals
    ...
    this.yAxis = new Axis_1.Axis(yMinMax, 'vertical', container); //bind

    this.tooltipsDraw = this.tooltipsDraw.bind(this);
    this.seriesReDraw = this.seriesReDraw.bind(this); //call methods
  ...
  Chart.prototype.bindChildSignals = function () {
    ...
    this.xAxis.onMinMaxSetted.add(function (hasPlotAnimation) {
      // @ts-ignore
      if (hasPlotAnimation) _this.seriesUpdatePlotData();
  ...
  Chart.prototype.setCanvasPaddings = function () {
    ...
    if (this.background) (_d = this.background.canvas).setPaddings.apply(_d, paddings);
    this.data.seriesStorage.forEach(function (series, ind) {
      var _a;
  ...
  Chart.prototype.addBackGround = function (type) {
    ...
    this.background = new BackGround_1.BackGround(type, this.container); //ticks
  ...
  Chart.prototype.tooltipsDraw = function (drawLast) {
    ...
    var transformer = new Transformer_1.Transformer();
    var delta_abs_buf = [];
    var delta_abs_buf_coord = []; // @ts-ignore
    ...
    this.data.seriesStorage.forEach(function (series) {
      ...
      var _a = series.getClosestDataPointX(sriesP),
          pointData = _a[0],
          tt_ind = _a[1];

      var _b = series.getClosestDataPointXY(sriesP),
          pointDataXY = _b[0],
          tt_ind_XY = _b[1];
              ...
              switch (tooltip.type) {
                case 'delta_abs':
                  if (delta_abs_buf.length == 0) {
                    ...
                    var absData = new Point_1.Point(Math.abs(pointData.x - delta_abs_buf[0].x), Math.abs(pointData.y - delta_abs_buf[0].y)); // @ts-ignore
                ...
                case 'data_label':
                  // @ts-ignore
                  tooltip.drawTooltip(_this.canvasTT.ctx, _this.canvasTT.viewport, new Point_1.Point(tooltipCoordXY.x, tooltipCoordXY.y), pointDataXY, tt_ind_XY); // @ts-ignore

                  if (plot.type == 'unicode') plot.drawPlot(_this.canvasTT.ctx, [tooltipCoordXY], _this.canvasTT.viewport, '', true);
                  break;
    ...
    data_y_end_buf.sort(function (a, b) {
      return a[1].y - b[1].y;
    });
    var hasOverlap = true;
    var counter = 0;
    ...
    while (hasOverlap && counter < data_y_end_buf.length * data_y_end_buf.length) {
      ...
      for (var i = 0; i < data_y_end_buf.length - 1; i++) {
        // @ts-ignore
        var rect1 = data_y_end_buf[i][0].drawTooltip(this.canvasTT.ctx, this.canvasTT.viewport, data_y_end_buf[i][1], data_y_end_buf[i][2], 0, false); // @ts-ignore
        ...
        if (rect1.y2 > rect2.y1) {
          ...
          data_y_end_buf[i][1].y = data_y_end_buf[i][1].y + abs1; // @ts-ignore
...
exports.Chart = Chart;
},{"./Canvas":"src/classes/Canvas.ts","./Data":"src/classes/Data.ts","./Plot":"src/classes/Plot.ts","./Axis":"src/classes/Axis.ts","./Transformer":"src/classes/Transformer.ts","./Rectangle":"src/classes/Rectangle.ts","./Point":"src/classes/Point.ts","./BackGround":"src/classes/BackGround.ts","signals":"node_modules/signals/dist/signals.js","./series/SeriesBase":"src/classes/series/SeriesBase.ts","./series/SeriesXY":"src/classes/series/SeriesXY.ts"}],"node_modules/bezier-easing/src/index.js":[function(require,module,exports) {
/**
...
},{}],"src/configs/indices-chart-black.ts":[function(require,module,exports) {
"use strict";
...
var easing = bezier(0.65, 0, 0.35, 1); // @ts-ignore
...
function createChart(container, data) {
  ...
  _a = __spreadArrays(data), xLabels = _a[0], cbhRow = _a[1], zeroSeries = _a[2], seriesLabeled = _a[3], seriesText = _a[4]; // ось X

  exports.chart.xAxis.setOptions('start', 0.5, 'black');
  exports.chart.xAxis.display = true;
  exports.chart.xAxis.ticks.display = true; // @ts-ignore
  ...
  exports.chart.xAxis.grid.setOptions(true, '#B2B2B2', 1, [1, 2]); // ось Y
  ...
  exports.chart.yAxis.grid.setOptions(true, '#B2B2B2', 1, [1, 2]); //добавляем custom ticks для Y
  ...
  var seriesL = [seriesLabeled[0], calculateDeviationsVal(seriesLabeled[1], cbhRow[0])]; // создаем Series и привязвыаем к ним инструменты отрисовки Plots
  ...
  exports.chart.addSeries('cyberHedge_labels', seriesL, seriesText).setPlotsIds('labeled'); // настраиваем Min Max осей
...
exports.createChart = createChart; // преобразование данных ряда из абсолютных величин в % относительно zeroPoint
  ...
  ranges.forEach(function (item) {
    item.addEventListener('click', function () {
      ...
      switch (item.innerHTML) {
        ...
        case 'YTD':
          minDate = new Date(new Date(maxDate.getFullYear(), 0, 1).getTime()), min = findDateInd(minDate);
          break;
      }
...
function reorganizeChart(cbhRow, min, max, onlyData) {
  ...
  var seriesL = [seriesLabeled[0], calculateDeviationsVal(seriesLabeled[1], cbhRow[min])]; // создаем Series
...
function findDateInd(date) {
  var ind = xLabels.reduce(function (prev, curr, i) {
    // @ts-ignore
    var curDif = Math.abs(curr - date); // @ts-ignore
...
},{"../classes/Chart":"src/classes/Chart.ts","../classes/Ticks":"src/classes/Ticks.ts","bezier-easing":"node_modules/bezier-easing/src/index.js"}],"src/configs/indices-chart-colored.ts":[function(require,module,exports) {
"use strict";
...
function createChart(container, data) {
  ...
  var _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p; // @ts-ignore
  ...
  exports.chart.tooltipsDataIndexUpdated.add(conncetBlueWidget); // ось X

  exports.chart.xAxis.setOptions('start', 0.5, 'black'); // @ts-ignore
  ...
  exports.chart.xAxis.ticks.settickDrawOptions(-6, 0.5, 'black');
  exports.chart.xAxis.ticks.label.setOptions(true, '#B2B2B2', 'bottom', 11, ['12', '"Transcript Pro"']);
  exports.chart.xAxis.ticks.label.isUpperCase = true; // ось Y
  ...
  (_d = exports.chart.findPlotById('blue_line')) === null || _d === void 0 ? void 0 : _d.addTooltip('ttId', 'line_horizontal_end', 1, '#B2B2B2', [1, 2]); // circles
  ...
  (_j = exports.chart.findPlotById('red_line')) === null || _j === void 0 ? void 0 : _j.addTooltip('ttId', 'circle_y_end', 3, '#ffffff', '#FF2222', 4); // labels

  (_k = exports.chart.findPlotById('red_line')) === null || _k === void 0 ? void 0 : _k.addTooltip('ttId', 'label_x_start', 0.5, 'black', '#ebebeb', 4, xLabels).label.setOptions(true, 'black', 'bottom', 14, ['12', '"Transcript Pro"']); // data
  ...
  (_m = exports.chart.findPlotById('blue_line')) === null || _m === void 0 ? void 0 : _m.addTooltip('ttId', 'data_y_end', 0.5, '#0070FF', '#0070FF', 4).label.setOptions(true, 'white', 'right', 30, ['12', '"Transcript Pro"']); // delta
  ...
  (_p = exports.chart.findPlotById('blue_line')) === null || _p === void 0 ? void 0 : _p.addTooltip('delta_1', 'delta_abs', 0.5, 'black', '#ebebeb', 4).label.setOptions(true, 'black', 'right', 35, ['12', '"Transcript Pro"']); // подготавливаем данные как на сайте CyberHedge

  var serie5star = calculateDeviationsVal(cbh5, cbh5[0]);
  var serie1star = calculateDeviationsVal(cbh1, cbh1[0]); // создаем Series
  ...
  exports.chart.addSeriesRow('zero_line', [zeroSeries]).setPlotsIds('zero_line'); // настраиваем Min Max осей
...
(function prepareCsvLoadMenu() {
  ...
  zoneItems.forEach(function (item) {
    item.addEventListener('click', function () {
      var link = item.querySelector('a'); // @ts-ignore

      document.querySelector('.zones_colored li.selected').classList.remove('selected');
      item.classList.add('selected');
      var rangeSelected = document.querySelector('.ranges_сolored li.selected'); // @ts-ignore

      helpers_1.customLoadDataFromCsv(link.href).then(function (data) {
        // @ts-ignore
        var chartData = helpers_1.csvToCols(data);
        cbh1 = chartData[2].slice(1).map(function (el) {
          return +el;
        });
        cbh5 = chartData[1].slice(1).map(function (el) {
          return +el;
        });
        xLabels = chartData[0].slice(1).map(function (el) {
          return new Date(el);
        });
        zeroSeries = cbh1.map(function () {
          return 0;
        }); //xLabels.sort();
        ...
        var min = 0;
        reorganizeChart(cbh5, cbh1, min, max, false); // @ts-ignore
...
function reorganizeChart(cbh5, cbh1, min, max, onlyData) {
  var _a, _b, _c, _d, _e; // подготавливаем данные как на сайте CyberHedge
  ...
  if (onlyData) {
    // @ts-ignore
    exports.chart.xAxis.setMinMax([min, max], false); // @ts-ignore
...
function setLastUpdateDate(lastDate) {
  ...
  var lastUpdateNode = document.querySelector('.last-update-colored time'); // @ts-ignore

  lastUpdateNode.datetime = lastDate.toISOString(); // @ts-ignore

  lastUpdateNode.innerHTML = [lastDate.getDate(), lastDate.toLocaleString('en-US', {
    month: 'long'
  }), lastDate.getFullYear()].join(' ');
} //поиск индекса ближайщей даты
...
},{"../classes/Chart":"src/classes/Chart.ts","../classes/Ticks":"src/classes/Ticks.ts","../scripts/helpers":"src/scripts/helpers.ts","bezier-easing":"node_modules/bezier-easing/src/index.js"}],"src/configs/indices-chart.ts":[function(require,module,exports) {
"use strict";
...
function createChart(container, data) {
  ...
  exports.chart.xAxis.ticks.label.setOptions(true, '#B2B2B2', 'bottom', 11, ['12', '"Transcript Pro"']); // ось Y

  exports.chart.yAxis.setOptions('end', 1, '#B2B2B2', [1, 2]);
  exports.chart.yAxis.display = true;
  exports.chart.yAxis.position = 'end';
  exports.chart.yAxis.ticks.label.setOptions(true, '#B2B2B2', 'right', 20, ['12', '"Transcript Pro"']); // создаем Plots

  exports.chart.addPlot('red_line', 'line', 1, '#FF2222', []);
  exports.chart.addPlot('red_area', 'area', 0, '#FFE5E5', '#FFE5E5', 0);
  exports.chart.addPlot('blue_line', 'line', 1, '#0070FF', []);
  exports.chart.addPlot('blue_area', 'area', 0, '#D9EAFF', '#D9EAFF', 0);
  exports.chart.addPlot('black_line', 'line', 1, '#000000', []); // создаем Tooltipы
  // lines
  ...
  var serie5star = dataNew.serie5star,
      area5starTop = dataNew.area5starTop,
      area5starBottom = dataNew.area5starBottom,
      serie1star = dataNew.serie1star,
      area1starTop = dataNew.area1starTop,
      area1starBottom = dataNew.area1starBottom; // создаем Series
  ...
  exports.chart.addSeriesRow('cyberHedge5_line', [serie5star]).setPlotsIds('blue_line');
  exports.chart.addSeriesRow('cyberHedge1_line', [serie1star]).setPlotsIds('red_line');
  exports.chart.addSeriesRow('zero_line', [zeroSeries]).setPlotsIds('black_line'); //настраиваем параметры осей

  exports.chart.yAxis.ticks.setOptions(false, 'niceCbhStep', [1, 5, 10, 15, 20, 25, 30]);
  exports.chart.yAxis.ticks.label.units = '%'; // @ts-ignore
  ...
  var easing = bezier(0.65, 0, 0.35, 1); //включаем анимацию
...
function prepareDataforCbh(star5, star1, fromIndex) {
  ...
  var serie5star = calculateDeviations(star5, fromIndex),
  ...
  return {
    serie5star: serie5star,
    area5starTop: area5starTop,
    area5starBottom: area5starBottom,
    serie1star: serie1star,
    area1starTop: area1starTop,
    area1starBottom: area1starBottom
  };
}

exports.prepareDataforCbh = prepareDataforCbh; // перевод из абсолютных величин в %
...
(function prepareCsvLoadMenu() {
  ...
  zoneItems.forEach(function (item) {
    item.addEventListener('click', function () {
      ...
      item.classList.add('selected');
      var rangeSelected = document.querySelector('.ranges_indices li.selected'); // @ts-ignore
...
function reorganizeChart(cbh5, cbh1, min, max, onlyData) {
  ...
  var serie5star = data.serie5star,
      area5starTop = data.area5starTop,
      area5starBottom = data.area5starBottom,
      serie1star = data.serie1star,
      area1starTop = data.area1starTop,
      area1starBottom = data.area1starBottom;
...
function setLastUpdateDate(lastDate) {
  // NOTE: fill last update node
  var lastUpdateNode = document.querySelector('.last-update time'); // @ts-ignore
...
},{"../classes/Chart":"src/classes/Chart.ts","../scripts/helpers":"src/scripts/helpers.ts","bezier-easing":"node_modules/bezier-easing/src/index.js"}],"src/classes/Legend.ts":[function(require,module,exports) {
"use strict";
...
},{"./Label":"src/classes/Label.ts"}],"src/configs/square-chart.ts":[function(require,module,exports) {
"use strict";
...
var Ticks_1 = require("../classes/Ticks"); // @ts-ignore
...
function prepareData(data) {
  ...
  var x, y, labels;
  var oneX = [1.3];
  var oneY = [2.5]; // @ts-ignore

  x = data[0].slice(1).map(function (el) {
    return +el;
  }); // @ts-ignore

  y = data[1].slice(1).map(function (el) {
    return +el;
  }); // @ts-ignore

  labels = data[2].slice(1).map(function (el) {
    return el;
  });
  return [x, y, oneX, oneY, labels];
}

exports.prepareData = prepareData; //функция создает и настраивает Chart квадратный
// @ts-ignore
...
function createChart(container, data) {
  ...
  _a = __spreadArrays(data), x = _a[0], y = _a[1], oneX = _a[2], oneY = _a[3], labels = _a[4]; // ось X
  ...
  exports.chart.xAxis.setName('Capital Managment', 'start').label.setOptions(true, 'black', 'top', -30, ['18', '"Transcript Pro"']); //легенда для оси X

  var lowRisk = new Legend_1.Legend(['Low', 'Risk'], function (vp) {
    return new Point_1.Point(vp.x1 - 25, vp.y2 + 25);
  });
  lowRisk.label.setOptions(true, 'black', 'top', 0, ['14', '"Transcript Pro"']);
  exports.chart.xAxis.addLegend(lowRisk);
  var highRisk = new Legend_1.Legend(['High', 'Risk'], function (vp) {
    return new Point_1.Point(vp.x2 + 25, vp.y1 - 25);
  });
  highRisk.label.setOptions(true, 'black', 'top', 0, ['14', '"Transcript Pro"']);
  exports.chart.xAxis.addLegend(highRisk); //добавляем custom ticks для X
  ...
  exports.chart.xAxis.addCustomTicks(newTicks); // ось Y
  ...
  exports.chart.yAxis.label.rotationAngle = -90; //добавляем custom ticks для Y
  ...
  exports.chart.yAxis.addCustomTicks(newYTicks); // контур графика

  exports.chart.hasBorder = true; // создаем Plots

  exports.chart.addPlot('uni_circles', 'unicode', 20, '#454e56', '●');
  exports.chart.addPlot('uni_triangle', 'unicode', 20, '#454e56', '▼'); //tt

  (_b = exports.chart.findPlotById('uni_circles')) === null || _b === void 0 ? void 0 : _b.addTooltip('ttId', 'data_label', 0.5, 'black', '#ebebeb', labels).label.setOptions(true, 'black', 'top', 15, ['12', '"Transcript Pro"']); //chart.findPlotById('uni_triangle')?.addTooltip('ttId', 'data_label', 0.5, 'black', '#ebebeb', labels).label.setOptions('black', 'top', 15, ['12', '"Transcript Pro"']);
  // создаем Series

  exports.chart.addSeries('portfolio', [x, y]).setPlotsIds('uni_circles');
  exports.chart.addSeries('portfolio_1', [oneX, oneY]).setPlotsIds('uni_triangle'); //включаем анимацию
  ...
  exports.chart.switchDataAnimation(true, 300);
  exports.chart.data.changeAllSeriesAnimationTimeFunction(easing); // задаем отступы для области отрисовки

  exports.chart.setCanvasPaddings(60, 60, 60, 60); // делаем квадратное соотношение

  exports.chart.switchResolution(); //обавляем фон

  exports.chart.addBackGround('coloredGrid_cbh');
  exports.chart.refresh(); // элементы управления

  var randBtn = document.getElementById('rand_btn'); //@ts-ignore
...
function reorganizeChart() {
  ...
  (_b = exports.chart.data.findSeriesById('portfolio_1')) === null || _b === void 0 ? void 0 : _b.replaceSeriesData([oneX, oneY], true); // @ts-ignore
...
*/
},{"../classes/Chart":"src/classes/Chart.ts","../classes/Legend":"src/classes/Legend.ts","../classes/Point":"src/classes/Point.ts","../classes/Ticks":"src/classes/Ticks.ts","bezier-easing":"node_modules/bezier-easing/src/index.js"}],"src/configs/indices-article.ts":[function(require,module,exports) {
"use strict";
...
function createChart(container, data) {
  ...
  var _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r; // @ts-ignore
  //chart = new Chart(container, [0, 900], [0, 2000]);


  exports.chart = new Chart_1.Chart(container, [0, 900], [0, 2000]);
  _a = __spreadArrays(data), xLabels = _a[0], cbh5 = _a[1], cbh1 = _a[2], cbh55 = _a[3], zeroSeries = _a[4], seriesLabeled = _a[5], seriesText = _a[6]; // перевести данные в % если нужно (точка 0 = cbh5[0] и cbh1[0] соответсвенно)
  ...
  setLastUpdateDate(xLabels[xLabels.length - 1]); // ось X
  ...
  (_k = exports.chart.findPlotById('red_line')) === null || _k === void 0 ? void 0 : _k.addTooltip('ttId', 'circle_y_end', 3, '#ffffff', '#FF2222', 4); // labels

  (_l = exports.chart.findPlotById('red_line')) === null || _l === void 0 ? void 0 : _l.addTooltip('ttId', 'label_x_start', 0.5, 'black', '#ebebeb', 4, xLabels).label.setOptions(true, 'black', 'bottom', 14, ['12', '"Transcript Pro"']); // data
  ...
  (_p = exports.chart.findPlotById('blue_line')) === null || _p === void 0 ? void 0 : _p.addTooltip('ttId', 'data_y_end', 0.5, '#0070FF', '#0070FF', 4).label.setOptions(true, 'white', 'right', 30, ['12', '"Transcript Pro"']); // delta
  ...
  (_r = exports.chart.findPlotById('blue_line')) === null || _r === void 0 ? void 0 : _r.addTooltip('delta_1', 'delta_abs', 0.5, 'black', '#ebebeb', 4).label.setOptions(true, 'black', 'right', 35, ['12', '"Transcript Pro"']); // создаем Series
  ...
  exports.chart.addSeriesRow('cyberHedge1_line', [serie1star]).setPlotsIds('red_line');
  exports.chart.addSeriesRow('zero_line', [zeroSeries]).setPlotsIds('zero_line');
  exports.chart.addSeries('cyberHedge_labels', seriesLabeled, seriesText).setPlotsIds('labeled'); //включаем анимацию
...
(function prepareCsvLoadMenu() {
  ...
  zoneItems.forEach(function (item) {
    item.addEventListener('click', function () {
      ...
      item.classList.add('selected');
      var rangeSelected = document.querySelector('.ranges_article li.selected'); // @ts-ignore
...
function setLastUpdateDate(lastDate) {
  // NOTE: fill last update node
  var lastUpdateNode = document.querySelector('.last-update-article time'); // @ts-ignore
...
},{"../classes/Chart":"src/classes/Chart.ts","../classes/Ticks":"src/classes/Ticks.ts","../scripts/helpers":"src/scripts/helpers.ts","bezier-easing":"node_modules/bezier-easing/src/index.js"}],"src/index.ts":[function(require,module,exports) {
"use strict"; // browserify ./src/index.ts -p [ tsify --noImplicitAny ] > chart-bundle.js
...
var webfontloader_1 = __importDefault(require("webfontloader")); // helpers


var helpers_1 = require("./scripts/helpers"); // config cbh-indicies-black


var indices_chart_black_1 = require("./configs/indices-chart-black"); // config cbh-indicies-colored


var indices_chart_colored_1 = require("./configs/indices-chart-colored"); // config cbh-indicies


var indices_chart_1 = require("./configs/indices-chart"); // config square-chart


var square_chart_1 = require("./configs/square-chart");

var square_chart_2 = require("./configs/square-chart"); // config indicies-article1


var indices_article_1 = require("./configs/indices-article"); //пути до CSV файлов
...
var article1_labels = './src/data/article1_labels.csv'; // проверка подгрузки шрифта
  ...
  active: function active() {
    ...
    helpers_1.customLoadDataFromCsv(article1).then(function (data) {
      helpers_1.customLoadDataFromCsv(article1_labels).then(function (dataLables) {
        var chartContainer = document.getElementById('indexChart_4'); // @ts-ignore

        var chartData = helpers_1.csvToCols(data);
        var cbh1 = chartData[2].slice(1).map(function (el) {
          return +el;
        }).reverse();
        var cbh5 = chartData[1].slice(1).map(function (el) {
          return +el;
        }).reverse();
        var cbh55 = chartData[1].slice(1).map(function (el) {
          return +el * -1;
        }).reverse();
        var xLabels = chartData[0].slice(1).map(function (el) {
          return new Date(el);
        }).reverse();
        var zeroSeries = cbh1.map(function () {
          return 0;
        }); // @ts-ignore

        var chartLables = helpers_1.csvToCols(dataLables);
        var x = chartLables[0].slice(1).map(function (el) {
          return +el;
        });
        var y = chartLables[1].slice(1).map(function (el) {
          return +el;
        });
        var texts = chartLables[2].slice(1).map(function (el) {
          return el;
    ...
    helpers_1.customLoadDataFromCsv(EU).then(function (data) {
      helpers_1.customLoadDataFromCsv(EU_Labels).then(function (dataLables) {
        var chartContainer = document.getElementById('indexChart_0'); // @ts-ignore

        var chartData = helpers_1.csvToCols(data);
        var cbh = chartData[1].slice(1).map(function (el) {
          return +el;
        });
        var xLabels = chartData[0].slice(1).map(function (el) {
          return new Date(el);
        });
        var zeroSeries = cbh.map(function () {
          return 0;
        }); // @ts-ignore
    ...
    helpers_1.customLoadDataFromCsv(startCSVurl).then(function (data) {
      var chartContainer = document.getElementById('indexChart_1'); // @ts-ignore
    ...
    helpers_1.customLoadDataFromCsv(startCSVurl).then(function (data) {
      var chartContainer = document.getElementById('indexChart_2'); // @ts-ignore
    ...
    helpers_1.customLoadDataFromCsv(sqrData).then(function (data) {
      var chartContainer = document.getElementById('indexChart_3'); // @ts-ignore

      var chartData = helpers_1.csvToCols(data); //разбираем CSV по рядам

      chartData = square_chart_2.prepareData(chartData); //создаем chart
...
},{"webfontloader":"node_modules/webfontloader/webfontloader.js","./scripts/helpers":"src/scripts/helpers.ts","./configs/indices-chart-black":"src/configs/indices-chart-black.ts","./configs/indices-chart-colored":"src/configs/indices-chart-colored.ts","./configs/indices-chart":"src/configs/indices-chart.ts","./configs/square-chart":"src/configs/square-chart.ts","./configs/indices-article":"src/configs/indices-article.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
