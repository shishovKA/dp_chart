...
function () {
  ...
  SeriesBase.prototype.updatePlotData = function (axisRect, vp, noAnimation) {
    var plotData = this.generatePlotData(axisRect, vp); //если нужна анимация графиков
...
*/
},{"../classes/Chart":"src/classes/Chart.ts","../classes/Legend":"src/classes/Legend.ts","../classes/Point":"src/classes/Point.ts","../classes/Ticks":"src/classes/Ticks.ts","bezier-easing":"node_modules/bezier-easing/src/index.js"}],"src/index.ts":[function(require,module,exports) {
...
var square_chart_2 = require("./configs/square-chart"); //пути до CSV файлов
...
var startCSVurl = './src/data/cbhPlotData_US.csv'; // проверка подгрузки шрифта
...
},{"webfontloader":"node_modules/webfontloader/webfontloader.js","./scripts/helpers":"src/scripts/helpers.ts","./configs/indices-chart-black":"src/configs/indices-chart-black.ts","./configs/indices-chart-colored":"src/configs/indices-chart-colored.ts","./configs/indices-chart":"src/configs/indices-chart.ts","./configs/square-chart":"src/configs/square-chart.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "5098" + '/');
