...
function createChart(container, data) {
  ...
  exports.chart.switchDataAnimation(true, 300);
  exports.chart.data.changeAllSeriesAnimationTimeFunction(easing); //обавляем фон

  exports.chart.addBackGround('coloredGrid_cbh'); // делаем квадратное соотношение

  exports.chart.switchResolution(); // задаем отступы для области отрисовки

  exports.chart.setCanvasPaddings(60, 60, 60, 60); // элементы управления
...
function createChart(container, data) {
  ...
  exports.chart = new Chart_1.Chart(container, [0, 900], [0, 2000]);
  _a = __spreadArrays(data), xLabels = _a[0], cbh5 = _a[1], cbh1 = _a[2], zeroSeries = _a[3], seriesLabeled = _a[4], seriesText = _a[5]; // перевести данные в % если нужно (точка 0 = cbh5[0] и cbh1[0] соответсвенно)
  ...
  (_o = exports.chart.findPlotById('red_line')) === null || _o === void 0 ? void 0 : _o.addTooltip('delta_1', 'delta_abs', 0.5, 'black', '#ebebeb', 4).label.setOptions(true, 'black', 'right', 35, ['12', '"Transcript Pro"']);
  (_p = exports.chart.findPlotById('blue_line')) === null || _p === void 0 ? void 0 : _p.addTooltip('delta_1', 'delta_abs', 0.5, 'black', '#ebebeb', 4).label.setOptions(true, 'black', 'right', 35, ['12', '"Transcript Pro"']); // создаем Series
  ...
  exports.chart.addSeriesRow('cyberHedge1_line', [serie1star]).setPlotsIds('red_line');
  exports.chart.addSeriesRow('zero_line', [zeroSeries]).setPlotsIds('zero_line');
  exports.chart.addSeries('cyberHedge_labels', seriesLabeled, seriesText).setPlotsIds('labeled'); // настраиваем Min Max осей
...
function reorganizeChart(cbh5, cbh1, min, max, onlyData) {
  ...
  var _a, _b, _c, _d, _e; // оставить исходные данные
  ...
  active: function active() {
    ...
    helpers_1.customLoadDataFromCsv(article1).then(function (data) {
      helpers_1.customLoadDataFromCsv(article1_labels).then(function (dataLables) {
        ...
        indices_article_1.createChart(chartContainer, [xLabels, cbh5, cbh1, zeroSeries, [x, y], texts]);
      });
    }).catch(function (err) {
      console.log(err);
    }); // черно-белый график
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "10976" + '/');
